...
const SQLCat = "SELECT idCategoria, nombreCategoria, urlCategoria, descripcionCategoria, imagenCategoria, idLabel FROM categorias"; 
...
const SQLabel = "SELECT idLabel, nombreLabel, grupoLabel, descripcionLabel, imgLabel FROM label";
...
class Principal extends PDO{
	...
	protected function obtener_etiquetas ($eti){
		$conectar = self::conectar()->prepare($eti);
		$conectar->execute();
