...
<section>
		...
		<article>
			...
			<p>
				<?php echo WEBPAGE; ?> asume que usted acepta el uso de cookies. No obstante, muestra información sobre su Política de cookies en la parte inferior o superior de cualquier página del portal con cada inicio de sesión con el objeto de que usted sea consciente.
			...
			<ol>
				...
				<li>
					Modificar su configuración. Podrá obtener más información sobre qué son las cookies, conocer la Política de cookies de <?php echo WEBPAGE; ?> y modificar la configuración de su navegador.
				</li>
			</ol>
		</article>
	</section>
